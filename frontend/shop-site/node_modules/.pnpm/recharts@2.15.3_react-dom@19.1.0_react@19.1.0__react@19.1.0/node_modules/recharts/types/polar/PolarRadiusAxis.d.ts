...
import { BaseAxisProps, TickItem, PresentationAttributesAdaptChildEvent } from '.pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/util/types';
...
export declare class PolarRadiusAxis extends PureComponent<Props> {
     ...
     * @return {Object} (x, y)
     */
    getTickValueCoord({ coordinate }: TickItem): import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/util/types").Coordinate;
